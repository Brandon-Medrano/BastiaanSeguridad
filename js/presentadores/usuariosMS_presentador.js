class UsuariosPresentadorMS
{
	 ...
	 consultar()
	 {
		 var repositorio = new UsuariosRepositorioMS(this);		
	 ...
	 {
		 var repositorio = new UsuariosRepositorioMS(this);			 
		 repositorio.insertar(this,this.insertarResultado,this.vista.usuarioMS);	
	 ...
	 {
		 var repositorio = new UsuariosRepositorioMS(this);		
		 repositorio.actualizar(this,this.actualizarResultado,this.vista.usuarioMS);
	 }
